    ...
    try:
        ...
        upsert_sql = f"""
            ...
            WHEN NOT MATCHED THEN
                INSERT (post_id, insta_id, insta_name, brand_name, brand_id, full_link,img_src,post_date,first_seen_at,last_seen_at,active,tagged_insta_id,tagged_insta_id_cnt)
                VALUES (stage.post_id, stage.insta_id, stage.insta_name, stage.brand_name, stage.brand_id, stage.full_link, stage.img_src, stage.post_date, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), TRUE,stage.tagged_insta_id,stage.tagged_insta_id_cnt);
        """
